...
contract DBSFVaultFactory is DBSFVaultFactoryData, IDBSFVaultFactory {
	...
	*/
	function transferVault(uint _index, address _to, bool _isYTVault) external override {
	...
	//--------------------------------------V-a-u-l-t---L-i-q-u-i-d-a-t-i-o-n-s-------------------------------------------
