...
import "../../interfaces/ICTokenWrapper.sol";
...
contract CTokenWrapper is ICTokenWrapper, CTokenWrapperInternals {
	...
	*/
	...
	/*
		@Description: force the CTokenWrapper to collect reward assets for msg.sender
	*/
    ...
    */
	...
	bool public constant override underlyingIsStatic = true;
