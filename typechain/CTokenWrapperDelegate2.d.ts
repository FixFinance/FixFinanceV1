...
interface CTokenWrapperDelegate2Interface extends ethers.utils.Interface {
  functions: {
...
export class CTokenWrapperDelegate2 extends Contract {
  ...
  interface: CTokenWrapperDelegate2Interface;
