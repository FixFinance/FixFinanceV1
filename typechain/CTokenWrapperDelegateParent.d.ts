...
interface CTokenWrapperDelegateParentInterface extends ethers.utils.Interface {
  functions: {
...
export class CTokenWrapperDelegateParent extends Contract {
  ...
  interface: CTokenWrapperDelegateParentInterface;
