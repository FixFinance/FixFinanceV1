...
interface DbsfVaultFactoryDelegate1Interface extends ethers.utils.Interface {
  functions: {
...
export class DbsfVaultFactoryDelegate1 extends Contract {
  ...
  interface: DbsfVaultFactoryDelegate1Interface;
