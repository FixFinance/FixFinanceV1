...
interface DbsfVaultFactoryDelegate2Interface extends ethers.utils.Interface {
  functions: {
...
export class DbsfVaultFactoryDelegate2 extends Contract {
  ...
  interface: DbsfVaultFactoryDelegate2Interface;
