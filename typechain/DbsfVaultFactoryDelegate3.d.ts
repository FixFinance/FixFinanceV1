...
interface DbsfVaultFactoryDelegate3Interface extends ethers.utils.Interface {
  functions: {
...
export class DbsfVaultFactoryDelegate3 extends Contract {
  ...
  interface: DbsfVaultFactoryDelegate3Interface;
