...
interface DbsfVaultFactoryDeployerInterface extends ethers.utils.Interface {
  functions: {
...
export class DbsfVaultFactoryDeployer extends Contract {
  ...
  interface: DbsfVaultFactoryDeployerInterface;
