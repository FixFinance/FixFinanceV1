...
interface DummyATokenInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setInflation(uint256)": FunctionFragment;
...
export class DummyAToken extends Contract {
  ...
  interface: DummyATokenInterface;
  ...
  functions: {
    ...
    inflation(overrides?: CallOverrides): Promise<{
      0: BigNumber;
    }>;
