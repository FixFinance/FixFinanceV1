...
import type { IdbsfVaultFactory } from "./IdbsfVaultFactory";

export class IdbsfVaultFactoryFactory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IdbsfVaultFactory {
    return new Contract(address, _abi, signerOrProvider) as IdbsfVaultFactory;
  }
}
