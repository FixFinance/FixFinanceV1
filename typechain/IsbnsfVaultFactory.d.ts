...
interface IsbnsfVaultFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class IsbnsfVaultFactory extends Contract {
  ...
  interface: IsbnsfVaultFactoryInterface;
