...
interface NgBwrapperInterface extends ethers.utils.Interface {
  functions: {
...
export class NgBwrapper extends Contract {
  ...
  functions: {
    ...
    editSubAccountPosition(
      ...
      _subAccount: string,
      _FCPaddr: string,
      _changeYield: BigNumberish,
      _changeBond: BigNumberish,
      overrides?: Overrides
    ): Promise<ContractTransaction>;
