...
interface NgBwrapperDelegate1Interface extends ethers.utils.Interface {
  functions: {
...
export class NgBwrapperDelegate1 extends Contract {
  ...
  interface: NgBwrapperDelegate1Interface;
