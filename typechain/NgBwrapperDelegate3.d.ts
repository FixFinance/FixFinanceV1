...
interface NgBwrapperDelegate3Interface extends ethers.utils.Interface {
  functions: {
...
export class NgBwrapperDelegate3 extends Contract {
  ...
  interface: NgBwrapperDelegate3Interface;
