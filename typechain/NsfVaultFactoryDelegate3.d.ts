...
interface NsfVaultFactoryDelegate3Interface extends ethers.utils.Interface {
  functions: {
...
export class NsfVaultFactoryDelegate3 extends Contract {
  ...
  interface: NsfVaultFactoryDelegate3Interface;
