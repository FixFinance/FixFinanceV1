...
interface NsfVaultFactoryDelegate4Interface extends ethers.utils.Interface {
  functions: {
...
export class NsfVaultFactoryDelegate4 extends Contract {
  ...
  interface: NsfVaultFactoryDelegate4Interface;
