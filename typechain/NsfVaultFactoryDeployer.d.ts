...
interface NsfVaultFactoryDeployerInterface extends ethers.utils.Interface {
  functions: {
...
export class NsfVaultFactoryDeployer extends Contract {
  ...
  interface: NsfVaultFactoryDeployerInterface;
