...
interface OrderbookExchangeInterface extends ethers.utils.Interface {
  functions: {
...
export class OrderbookExchange extends Contract {
  ...
  interface: OrderbookExchangeInterface;
