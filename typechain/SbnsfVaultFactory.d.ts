...
interface SbnsfVaultFactoryInterface extends ethers.utils.Interface {
  functions: {
    ...
    "wrapperToUnderlyingAsset(address)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "wrapperToUnderlyingAsset",
    values: [string]
  ): string;
...
export class SbnsfVaultFactory extends Contract {
  ...
  interface: SbnsfVaultFactoryInterface;
  ...
  functions: {
    ...
    "wrapperToUnderlyingAsset(address)"(
      _wrapperAddress: string,
      overrides?: CallOverrides
    ): Promise<{
      0: string;
  ...
  estimateGas: {
    ...
    YTrevenue(_asset: string, overrides?: CallOverrides): Promise<BigNumber>;
