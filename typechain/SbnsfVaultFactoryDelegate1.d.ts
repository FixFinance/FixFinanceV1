...
interface SbnsfVaultFactoryDelegate1Interface extends ethers.utils.Interface {
  functions: {
...
export class SbnsfVaultFactoryDelegate1 extends Contract {
  ...
  interface: SbnsfVaultFactoryDelegate1Interface;
