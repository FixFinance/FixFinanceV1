...
interface SbnsfVaultFactoryDelegate2Interface extends ethers.utils.Interface {
  functions: {
...
export class SbnsfVaultFactoryDelegate2 extends Contract {
  ...
  interface: SbnsfVaultFactoryDelegate2Interface;
