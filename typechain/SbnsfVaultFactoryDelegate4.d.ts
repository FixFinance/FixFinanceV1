...
interface SbnsfVaultFactoryDelegate4Interface extends ethers.utils.Interface {
  functions: {
...
export class SbnsfVaultFactoryDelegate4 extends Contract {
  ...
  interface: SbnsfVaultFactoryDelegate4Interface;
