...
interface SbnsfVaultFactoryDelegate5Interface extends ethers.utils.Interface {
  functions: {
...
export class SbnsfVaultFactoryDelegate5 extends Contract {
  ...
  interface: SbnsfVaultFactoryDelegate5Interface;
