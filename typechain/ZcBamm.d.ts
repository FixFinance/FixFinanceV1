...
interface ZcBammInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setOracleRate(int128)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setOracleRate",
    values: [BigNumberish]
  ): string;
...
export class ZcBamm extends Contract {
